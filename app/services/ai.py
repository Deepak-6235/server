...
from app.services.s3 import upload_video_bytes_to_s3, upload_stream_to_s3, upload_file_to_s3
            ...
            for part in response.candidates[0].content.parts:
                if part.inline_data:
                    if image_count < 6:
                        ...
                        s3_key = f"images/{product_name}_{angle}_{timestamp}.png"

                        # Upload directly to S3 from bytes with image content type
                        s3_url = upload_video_bytes_to_s3(part.inline_data.data, s3_key, content_type='image/png')
